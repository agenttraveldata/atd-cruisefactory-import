...
class Facility extends AbstractFeed {
	protected static string $tableName = 'atd_cfi_ship_facility';
	protected static string $feedName = 'facilities';
	protected static string $entity = Entity\Facility::class;
