<form class="atd-cfi-sf" action="<?php echo is_tax() ? get_term_link( 'special', 'atd_cf_departure_type' ) : get_post_type_archive_link( 'departure' ); ?>" data-controller="atd-cfi-search-form">
	<?php if ( is_tax() ): ?>
