...
<div class="atd-cfi-single__details">
    ...
    <div class="atd-cfi-single-details__cruise-line">
        <img class="atd-cfi__img-fluid" src="<?php echo get_the_post_thumbnail_url( $cruiseLinePost ); ?>"
             alt="<?php echo $cruiseLinePost->post_title; ?>">
        <p><a href="<?php echo get_permalink( $cruiseLinePost->ID ); ?>"><?php echo $cruiseLinePost->post_title; ?></a>
        </p>
    </div>
</div>
