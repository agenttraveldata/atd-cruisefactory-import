    ...
    <select name="cabin_price" class="atd-cfi__input" id="atd-cfi-departure-price-single">
		<?php if ( $prices = $atdDeparture->getCruisePrices()->filter( function ( $p ) {
            ...
            <option value="<?php echo $price->getId(); ?>">
				<?php echo $price->getCabin(); ?> - <?php echo $price->getCurrency() . number_format( $price->getPriceSingle() ) . 'pp'; ?>
            </option>
		<?php endforeach;
		else: ?>
...
<div class="atd-cfi__mb-2" data-atd-cfi-toggle-element-target="element">
    ...
    <select name="cabin_price" class="atd-cfi__input" id="atd-cfi-departure-price-twin">
		<?php if ( $prices = $atdDeparture->getCruisePrices()->filter( function ( $p ) {
            ...
            <option value="<?php echo $price->getId(); ?>">
				<?php echo $price->getCabin(); ?> - <?php echo $price->getCurrency() . number_format( $price->getPriceDouble() ) . 'pp'; ?>
            </option>
		<?php endforeach;
		else: ?>
            <option value="">Request Price</option>
...
<div class="atd-cfi__mb-2" data-atd-cfi-toggle-element-target="element">
    ...
    <select name="cabin_price" class="atd-cfi__input" id="atd-cfi-departure-price-triple">
		<?php if ( $prices = $atdDeparture->getCruisePrices()->filter( function ( $p ) {
            ...
            <option value="<?php echo $price->getId(); ?>">
				<?php echo $price->getCabin(); ?> - <?php echo $price->getCurrency() . number_format( $price->getPriceTriple() ) . 'pp'; ?>
            </option>
		<?php endforeach;
		else: ?>
            <option value="">Request Price</option>
...
<div class="atd-cfi__mb-2" data-atd-cfi-toggle-element-target="element">
    ...
    <select name="cabin_price" class="atd-cfi__input" id="atd-cfi-departure-price-quad">
		<?php if ( $prices = $atdDeparture->getCruisePrices()->filter( function ( $p ) {
            ...
            <option value="<?php echo $price->getId(); ?>">
				<?php echo $price->getCabin(); ?> - <?php echo $price->getCurrency() . number_format( $price->getPriceQuad() ) . 'pp'; ?>
            </option>
		<?php endforeach;
		else: ?>
            <option value="">Request Price</option>
