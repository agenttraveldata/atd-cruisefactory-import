...
<div class="atd-cfi__tabs" data-controller="atd-cfi-tabs">
    ...
    <div class="atd-cfi-tabs__contents" data-atd-cfi-tabs-target="contents" data-controller="atd-cfi-popover">
        ...
        <div id="atd-tab-departures"
             ...
             data-atd-cfi-ajax-results-param-value='{"atd_cf_filter[<?php echo ATD\CruiseFactory\Taxonomy\CruiseLine::$name; ?>]": "<?php echo $atdCruiseLine->getId(); ?>"}'
		...
		<?php if ( $atdCruiseLine->getShips()->count() > 0 ): ?>
            <div id="atd-tab-ships">
				<?php $q = atd_cf_get_query_for_posts_by_meta( ATD\CruiseFactory\Post\Ship::$postType, array_column( $atdCruiseLine->getShips()->toArray(), 'id' ) ); ?>
